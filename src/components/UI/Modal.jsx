...
const Modal = ({ activeID, setShowModal }) => {
  ...
  return (
    <div className='w-full h-full fixed top-0 left-0 z-10 bg-headingColor bg-opacity-40'>
      <div className="w-11/12 md:max-w-[600px] md:w-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20 bg-white rounded-[8px] p-5">
        <div className="text-center mb-5">
          <figure className="inline-block">
            <img className='rounded-[8px]' src={portfolio.imgUrl.src} alt="" />
          </figure>
        </div>
        <div>
          <h2 className='text-[15px] leading-7 text-smallTextColor font-[700] my-5'>
            {portfolio.title}
          </h2>
